<template>
    <nav class="fixed top-0 left-0 right-0 py-4 md:py-8 bg-black bg-opacity-50">
        <div class="container flex items-center mx-auto">
            <NuxtLink class="flex items-center gap-0 md:gap-4">
        ...
        <div v-if="false" class="dropdown flex flex-col items-end pe-4 gap-4">
            <NuxtLink class="text-white text-xl hover:text-pink-500 hover:cursor-pointer transition-all">Movies</NuxtLink>
            <NuxtLink class="text-white text-xl hover:text-pink-500 hover:cursor-pointer transition-all">TV Shows</NuxtLink>
        </div>
    </nav>
</template>
